...
-->
<!-- [5] body Layout 영역 -->
<!-- <link href="/resources/css/projectname_layout.css" rel="stylesheet"> -->
<!-- header 영역 style -->
<!-- <link href="resources/css/projectname_header.css" rel="stylesheet"> -->

<!-- footer 영역 style -->
<style>
     @import url("${pageContext.request.contextPath}/resources/css/projectname_footer.css"); 
</style>
<!-- aside 영역 style -->
<style>
    @import url("${pageContext.request.contextPath}/resources/css/projectname_aside.css");
</style>
<!-- section/article 영역 style -->
<style>
    @import url("${pageContext.request.contextPath}/resources/css/projectname_section.css?after");
</style>
                ...
                <article id="table_wrap">
                    <table>
                        <tbody>
                            ...
                            <tr>
                                <td><div><img src="https://dummyimage.com/180/ccc"><span>그림1</span></div></td>
...
<!-- 
 ...
 -->
                ...
                <div class="labels">
                    <label for="first" id="test1">First</label>
                    <label for="second" id="test2">Second</label>
                </div>
                <div class="items">
                    <div class="tab-item">
                        <ul>
                            <li>
                                <div class="thumnail">
                                    <a href="#">
                                        <img src="/resources/images/ryan.svg" height="45" width="45">
                                    </a>
                                </div>
                                <div class="descript">
                                    <a href="#">
